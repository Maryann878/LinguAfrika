            ...
            <li key={index} className="flex items-center gap-1.5">
              {index === 0 ? (
                <Link
                  to={crumb.path || '#'}
                  className={cn(
                    "flex items-center gap-1.5 hover:text-primary transition-colors px-2 py-1 rounded-md hover:bg-primary/5",
                ...
                <>
                  ...
                  {crumb.path && !isLast ? (
                    <Link
                      to={crumb.path}
                      className="hover:text-primary transition-colors px-2 py-1 rounded-md hover:bg-primary/5 leading-none"
